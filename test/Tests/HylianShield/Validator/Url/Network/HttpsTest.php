 ...
 * Https test.
 */
class HttpsTest extends \Tests\HylianShield\Validator\TestBase
{
    /**
     ...
     */
    protected $validatorClass = '\HylianShield\Validator\Url\Network\Https';
